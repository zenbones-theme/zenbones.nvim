...
if &background ==# 'dark'
    ...
    highlight Normal guifg=#EBEFC0 guibg=#0E101A guisp=NONE
    highlight Bold guifg=NONE guibg=NONE guisp=NONE gui=bold cterm=bold
    highlight! link LightspeedUnlabeledMatch Bold
    highlight! link TSStrong Bold
    highlight BufferVisible guifg=#F0F5C4 guibg=NONE guisp=NONE
    highlight BufferVisibleIndex guifg=#F0F5C4 guibg=NONE guisp=NONE
    highlight BufferVisibleSign guifg=#F0F5C4 guibg=NONE guisp=NONE
    highlight CmpItemAbbr guifg=#C6CAA1 guibg=NONE guisp=NONE
    highlight CmpItemAbbrDeprecated guifg=#818368 guibg=NONE guisp=NONE
    ...
    highlight CmpItemKind guifg=#AEB18D guibg=NONE guisp=NONE
    highlight CmpItemMenu guifg=#9EA080 guibg=NONE guisp=NONE
    highlight CocMarkdownLink guifg=#00A3CB guibg=NONE guisp=NONE gui=underline cterm=underline
    highlight ColorColumn guifg=NONE guibg=#443426 guisp=NONE
    ...
    highlight Cursor guifg=#0E101A guibg=#EDF2C2 guisp=NONE
    highlight! link TermCursor Cursor
    highlight CursorLine guifg=NONE guibg=#161926 guisp=NONE
    highlight! link CursorColumn CursorLine
    highlight! link NeogitDiffContextHighlight CursorLine
    highlight! link TelescopeSelection CursorLine
    highlight CursorLineNr guifg=#EBEFC0 guibg=NONE guisp=NONE gui=bold cterm=bold
    highlight Delimiter guifg=#6D759D guibg=NONE guisp=NONE
    highlight! link markdownLinkTextDelimiter Delimiter
    highlight! link NeogitNotificationError DiagnosticError
    highlight DiagnosticHint guifg=#795CCC guibg=NONE guisp=NONE
    highlight DiagnosticInfo guifg=#00A3CB guibg=NONE guisp=NONE
    highlight! link NeogitNotificationInfo DiagnosticInfo
    highlight! link TSNote DiagnosticInfo
    highlight DiagnosticSignError guifg=#E03600 guibg=NONE guisp=NONE
    highlight! link CocErrorSign DiagnosticSignError
    highlight DiagnosticSignHint guifg=#795CCC guibg=NONE guisp=NONE
    highlight! link CocHintSign DiagnosticSignHint
    highlight DiagnosticSignInfo guifg=#00A3CB guibg=NONE guisp=NONE
    highlight! link CocInfoSign DiagnosticSignInfo
    highlight DiagnosticSignWarn guifg=#E39500 guibg=NONE guisp=NONE
    ...
    highlight DiagnosticVirtualTextError guifg=#E03600 guibg=#1E1818 guisp=NONE
    highlight! link CocErrorVirtualText DiagnosticVirtualTextError
    highlight DiagnosticVirtualTextHint guifg=#795CCC guibg=#1A191E guisp=NONE
    highlight DiagnosticVirtualTextInfo guifg=#00A3CB guibg=#181A1B guisp=NONE
    highlight DiagnosticVirtualTextWarn guifg=#E39500 guibg=#1B1918 guisp=NONE
    highlight! link CocWarningVitualText DiagnosticVirtualTextWarn
    highlight! link NeogitNotificationWarning DiagnosticWarn
    highlight DiffAdd guifg=NONE guibg=#15251C guisp=NONE
    highlight! link NeogitDiffAddHighlight DiffAdd
    highlight DiffChange guifg=NONE guibg=#17232A guisp=NONE
    highlight DiffDelete guifg=NONE guibg=#311C1A guisp=NONE
    highlight! link NeogitDiffDeleteHighlight DiffDelete
    highlight DiffText guifg=#EBEFC0 guibg=#2A3E48 guisp=NONE
    highlight Directory guifg=NONE guibg=NONE guisp=NONE gui=bold cterm=bold
    highlight Error guifg=#E03600 guibg=NONE guisp=NONE
    highlight! link DiagnosticError Error
    highlight! link ErrorMsg Error
    highlight! link TSDanger Error
    highlight FloatBorder guifg=#6B729B guibg=NONE guisp=NONE
    highlight FoldColumn guifg=#51587A guibg=NONE guisp=NONE gui=bold cterm=bold
    highlight Folded guifg=#9A9FBC guibg=#272B3E guisp=NONE
    highlight Function guifg=#EBEFC0 guibg=NONE guisp=NONE
    highlight! link TroubleNormal Function
    highlight! link TroubleText Function
    highlight GitSignsAdd guifg=#5DCD97 guibg=NONE guisp=NONE
    highlight! link GitGutterAdd GitSignsAdd
    highlight GitSignsChange guifg=#00A3CB guibg=NONE guisp=NONE
    highlight! link GitGutterChange GitSignsChange
    highlight GitSignsDelete guifg=#E03600 guibg=NONE guisp=NONE
    highlight! link GitGutterDelete GitSignsDelete
    highlight HopNextKey2 guifg=#00A3CB guibg=NONE guisp=NONE
    highlight Identifier guifg=#C6CAA1 guibg=NONE guisp=NONE
    highlight! link TSVariable Identifier
    highlight IncSearch guifg=#0E101A guibg=#9A87DC guisp=NONE gui=bold cterm=bold
    highlight! link CurSearch IncSearch
    highlight IndentBlanklineChar guifg=#292B3A guibg=NONE guisp=NONE
    highlight Italic guifg=NONE guibg=NONE guisp=NONE gui=italic cterm=italic
    highlight! link TSEmphasis Italic
    highlight! link markdownTSEmphasis Italic
    highlight LightspeedGreyWash guifg=#5A5F7B guibg=NONE guisp=NONE
    ...
    highlight LightspeedPendingChangeOpArea guifg=#795CCC guibg=NONE guisp=NONE
    highlight LightspeedShortcut guifg=#0E101A guibg=#795CCC guisp=NONE gui=bold,underline cterm=bold,underline
    highlight LineNr guifg=#51587A guibg=NONE guisp=NONE
    ...
    highlight NonText guifg=#484E6D guibg=NONE guisp=NONE
    highlight! link EndOfBuffer NonText
    highlight! link Whitespace NonText
    highlight NormalFloat guifg=NONE guibg=#222536 guisp=NONE
    ...
    highlight NvimTreeCursorLine guifg=NONE guibg=#1A1D2B guisp=NONE
    highlight! link NvimTreeCursorColumn NvimTreeCursorLine
    highlight NvimTreeNormal guifg=#EBEFC0 guibg=#151723 guisp=NONE
    ...
    highlight NvimTreeSymlink guifg=#00A3CB guibg=NONE guisp=NONE
    highlight NvimTreeVertSplit guifg=bg guibg=NONE guisp=NONE
    highlight Pmenu guifg=NONE guibg=#222536 guisp=NONE
    highlight PmenuSbar guifg=NONE guibg=#4B5170 guisp=NONE
    highlight PmenuSel guifg=NONE guibg=#383C55 guisp=NONE
    highlight PmenuThumb guifg=NONE guibg=#757DA3 guisp=NONE
    highlight PreProc guifg=#00A3CB guibg=NONE guisp=NONE
    highlight Search guifg=#EBEFC0 guibg=#4D3191 guisp=NONE
    highlight! link CocSearch Search
    highlight! link MatchParen Search
    highlight! link Sneak Search
    highlight! link LightspeedPendingOpArea SneakLabel
    highlight SneakLabelMask guifg=#795CCC guibg=#795CCC guisp=NONE
    highlight Special guifg=#5DCD97 guibg=NONE guisp=NONE
    ...
    highlight SpecialComment guifg=#5A5F7B guibg=NONE guisp=NONE
    ...
    highlight StatusLine guifg=#EBEFC0 guibg=#232738 guisp=NONE
    highlight! link TabLine StatusLine
    highlight StatusLineNC guifg=#F0F5C4 guibg=#1A1D2B guisp=NONE
    ...
    highlight TelescopeBorder guifg=#6B729B guibg=NONE guisp=NONE
    highlight TelescopeMatching guifg=#795CCC guibg=NONE guisp=NONE gui=bold cterm=bold
    highlight TelescopeSelectionCaret guifg=#E03600 guibg=#161926 guisp=NONE
    ...
    highlight Type guifg=#898FB1 guibg=NONE guisp=NONE
    ...
    highlight VertSplit guifg=#51587A guibg=NONE guisp=NONE
    highlight Visual guifg=NONE guibg=#37382D guisp=NONE
    highlight WarningMsg guifg=#E39500 guibg=NONE guisp=NONE
    highlight! link DiagnosticWarn WarningMsg
    highlight! link TSWarning WarningMsg
    highlight! link gitcommitOverflow WarningMsg
    highlight WildMenu guifg=#0E101A guibg=#795CCC guisp=NONE
    highlight! link SneakLabel WildMenu
    highlight diffAdded guifg=#5DCD97 guibg=NONE guisp=NONE
    highlight! link NvimTreeGitNew diffAdded
    highlight diffChanged guifg=#00A3CB guibg=NONE guisp=NONE
    highlight! link NvimTreeGitDirty diffChanged
    highlight diffFile guifg=#E39500 guibg=NONE guisp=NONE gui=bold cterm=bold
    highlight diffIndexLine guifg=#E39500 guibg=NONE guisp=NONE
    ...
    highlight diffRemoved guifg=#E03600 guibg=NONE guisp=NONE
    highlight! link NvimTreeGitDeleted diffRemoved
    highlight lCursor guifg=#0E101A guibg=#939677 guisp=NONE
