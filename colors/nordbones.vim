...
if &background ==# 'dark'
    ...
    highlight Normal guifg=#EBEEF3 guibg=#2F3541 guisp=NONE
    highlight Bold guifg=NONE guibg=NONE guisp=NONE gui=bold cterm=bold
    highlight! link LightspeedUnlabeledMatch Bold
    highlight! link TSStrong Bold
    highlight BufferVisible guifg=#F2F4F7 guibg=NONE guisp=NONE
    highlight BufferVisibleIndex guifg=#F2F4F7 guibg=NONE guisp=NONE
    highlight BufferVisibleSign guifg=#F2F4F7 guibg=NONE guisp=NONE
    highlight CmpItemAbbr guifg=#BFCADB guibg=NONE guisp=NONE
    highlight CmpItemAbbrDeprecated guifg=#7285A0 guibg=NONE guisp=NONE
    ...
    highlight CmpItemKind guifg=#9EAFC9 guibg=NONE guisp=NONE
    highlight CmpItemMenu guifg=#8DA2C0 guibg=NONE guisp=NONE
    highlight CocMarkdownLink guifg=#87BFCE guibg=NONE guisp=NONE gui=underline cterm=underline
    highlight ColorColumn guifg=NONE guibg=#825243 guisp=NONE
    ...
    highlight Cursor guifg=#2F3541 guibg=#EEF1F5 guisp=NONE
    highlight! link TermCursor Cursor
    highlight CursorLine guifg=NONE guibg=#353C49 guisp=NONE
    highlight! link CursorColumn CursorLine
    highlight! link NeogitDiffContextHighlight CursorLine
    highlight! link TelescopeSelection CursorLine
    highlight CursorLineNr guifg=#EBEEF3 guibg=NONE guisp=NONE gui=bold cterm=bold
    highlight Delimiter guifg=#818EAB guibg=NONE guisp=NONE
    highlight! link markdownLinkTextDelimiter Delimiter
    highlight! link NeogitNotificationError DiagnosticError
    highlight DiagnosticHint guifg=#B38DAC guibg=NONE guisp=NONE
    highlight DiagnosticInfo guifg=#8FBCBA guibg=NONE guisp=NONE
    highlight! link NeogitNotificationInfo DiagnosticInfo
    highlight! link TSNote DiagnosticInfo
    highlight DiagnosticSignError guifg=#C1616A guibg=NONE guisp=NONE
    highlight! link CocErrorSign DiagnosticSignError
    highlight DiagnosticSignHint guifg=#B38DAC guibg=NONE guisp=NONE
    highlight! link CocHintSign DiagnosticSignHint
    highlight DiagnosticSignInfo guifg=#8FBCBA guibg=NONE guisp=NONE
    highlight! link CocInfoSign DiagnosticSignInfo
    highlight DiagnosticSignWarn guifg=#CF866F guibg=NONE guisp=NONE
    ...
    highlight DiagnosticVirtualTextError guifg=#C1616A guibg=#463B3B guisp=NONE
    highlight! link CocErrorVirtualText DiagnosticVirtualTextError
    highlight DiagnosticVirtualTextHint guifg=#B38DAC guibg=#423C41 guisp=NONE
    highlight DiagnosticVirtualTextInfo guifg=#8FBCBA guibg=#3B3E3E guisp=NONE
    highlight DiagnosticVirtualTextWarn guifg=#CF866F guibg=#433C3B guisp=NONE
    highlight! link CocWarningVitualText DiagnosticVirtualTextWarn
    highlight! link NeogitNotificationWarning DiagnosticWarn
    highlight DiffAdd guifg=NONE guibg=#3D4B2F guisp=NONE
    highlight! link NeogitDiffAddHighlight DiffAdd
    highlight DiffChange guifg=NONE guibg=#324B4B guisp=NONE
    highlight DiffDelete guifg=NONE guibg=#663A3E guisp=NONE
    highlight! link NeogitDiffDeleteHighlight DiffDelete
    highlight DiffText guifg=#EBEEF3 guibg=#476968 guisp=NONE
    highlight Directory guifg=NONE guibg=NONE guisp=NONE gui=bold cterm=bold
    highlight Error guifg=#C1616A guibg=NONE guisp=NONE
    highlight! link DiagnosticError Error
    highlight! link ErrorMsg Error
    highlight! link TSDanger Error
    highlight FloatBorder guifg=#7E8CA8 guibg=NONE guisp=NONE
    highlight FoldColumn guifg=#69758C guibg=NONE guisp=NONE gui=bold cterm=bold
    highlight Folded guifg=#A8B1C5 guibg=#464E5F guisp=NONE
    highlight Function guifg=#87BFCE guibg=NONE guisp=NONE
    highlight! link TroubleNormal Function
    highlight! link TroubleText Function
    highlight GitSignsAdd guifg=#A4BE8D guibg=NONE guisp=NONE
    highlight! link GitGutterAdd GitSignsAdd
    highlight GitSignsChange guifg=#8FBCBA guibg=NONE guisp=NONE
    highlight! link GitGutterChange GitSignsChange
    highlight GitSignsDelete guifg=#C1616A guibg=NONE guisp=NONE
    highlight! link GitGutterDelete GitSignsDelete
    highlight HopNextKey2 guifg=#8FBCBA guibg=NONE guisp=NONE
    highlight Identifer guifg=#EBEEF3 guibg=NONE guisp=NONE
    highlight Identifier guifg=#BFCADB guibg=NONE guisp=NONE
    highlight! link TSVariable Identifier
    highlight IncSearch guifg=#2F3541 guibg=#D1BACD guisp=NONE gui=bold cterm=bold
    highlight! link CurSearch IncSearch
    highlight IndentBlanklineChar guifg=#474E5B guibg=NONE guisp=NONE
    highlight Italic guifg=NONE guibg=NONE guisp=NONE gui=italic cterm=italic
    highlight! link TSEmphasis Italic
    highlight! link markdownTSEmphasis Italic
    highlight LightspeedGreyWash guifg=#737C90 guibg=NONE guisp=NONE
    ...
    highlight LightspeedPendingChangeOpArea guifg=#B38DAC guibg=NONE guisp=NONE
    highlight LightspeedShortcut guifg=#2F3541 guibg=#B38DAC guisp=NONE gui=bold,underline cterm=bold,underline
    highlight LineNr guifg=#69758C guibg=NONE guisp=NONE
    ...
    highlight NonText guifg=#606B81 guibg=NONE guisp=NONE
    highlight! link EndOfBuffer NonText
    highlight! link Whitespace NonText
    highlight NormalFloat guifg=NONE guibg=#3F4756 guisp=NONE
    ...
    highlight NvimTreeCursorLine guifg=NONE guibg=#39404E guisp=NONE
    highlight! link NvimTreeCursorColumn NvimTreeCursorLine
    highlight NvimTreeNormal guifg=#EBEEF3 guibg=#333946 guisp=NONE
    ...
    highlight NvimTreeSymlink guifg=#8FBCBA guibg=NONE guisp=NONE
    highlight NvimTreeVertSplit guifg=bg guibg=NONE guisp=NONE
    highlight Pmenu guifg=NONE guibg=#3F4756 guisp=NONE
    highlight PmenuSbar guifg=NONE guibg=#657087 guisp=NONE
    highlight PmenuSel guifg=NONE guibg=#535C6F guisp=NONE
    highlight PmenuThumb guifg=NONE guibg=#8694B0 guisp=NONE
    highlight Search guifg=#EBEEF3 guibg=#84637E guisp=NONE
    highlight! link CocSearch Search
    highlight! link MatchParen Search
    highlight! link Sneak Search
    highlight! link LightspeedPendingOpArea SneakLabel
    highlight SneakLabelMask guifg=#B38DAC guibg=#B38DAC guisp=NONE
    ...
    highlight SpecialComment guifg=#737C90 guibg=NONE guisp=NONE
    ...
    highlight Statement guifg=#81A1C1 guibg=NONE guisp=NONE
    highlight! link PreProc Statement
    highlight! link WhichKey Statement
    highlight! link markdownTSTitle Statement
    highlight StatusLine guifg=#EBEEF3 guibg=#414959 guisp=NONE
    highlight! link TabLine StatusLine
    highlight StatusLineNC guifg=#F2F4F7 guibg=#39404E guisp=NONE
    ...
    highlight TelescopeBorder guifg=#7E8CA8 guibg=NONE guisp=NONE
    highlight TelescopeMatching guifg=#B38DAC guibg=NONE guisp=NONE gui=bold cterm=bold
    highlight TelescopeSelectionCaret guifg=#C1616A guibg=#353C49 guisp=NONE
    ...
    highlight Type guifg=#5E81AB guibg=NONE guisp=NONE
    ...
    highlight VertSplit guifg=#69758C guibg=NONE guisp=NONE
    highlight Visual guifg=NONE guibg=#545F70 guisp=NONE
    highlight WarningMsg guifg=#CF866F guibg=NONE guisp=NONE
    highlight! link DiagnosticWarn WarningMsg
    highlight! link TSWarning WarningMsg
    highlight! link gitcommitOverflow WarningMsg
    highlight WildMenu guifg=#2F3541 guibg=#B38DAC guisp=NONE
    highlight! link SneakLabel WildMenu
    highlight diffAdded guifg=#A4BE8D guibg=NONE guisp=NONE
    highlight! link NvimTreeGitNew diffAdded
    highlight diffChanged guifg=#8FBCBA guibg=NONE guisp=NONE
    highlight! link NvimTreeGitDirty diffChanged
    highlight diffFile guifg=#CF866F guibg=NONE guisp=NONE gui=bold cterm=bold
    highlight diffIndexLine guifg=#CF866F guibg=NONE guisp=NONE
    ...
    highlight diffRemoved guifg=#C1616A guibg=NONE guisp=NONE
    highlight! link NvimTreeGitDeleted diffRemoved
    highlight lCursor guifg=#2F3541 guibg=#8297B6 guisp=NONE
