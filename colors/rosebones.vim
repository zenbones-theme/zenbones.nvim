...
if &background ==# 'dark'
    ...
    highlight markdownTSTextReference guifg=#C2A19F guibg=NONE guisp=NONE gui=underline cterm=underline
    " dark end
    ...
    highlight markdownTSTextReference guifg=#A4635F guibg=NONE guisp=NONE gui=underline cterm=underline
    " light end
