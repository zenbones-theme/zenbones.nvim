...
if &background ==# 'dark'
    ...
    highlight SnacksPickerMatch guifg=#9CCFD8 guibg=NONE guisp=NONE gui=bold cterm=bold
    ...
    highlight SnacksPickerMatch guifg=#5795A0 guibg=NONE guisp=NONE gui=bold cterm=bold
