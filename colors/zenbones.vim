...
if &background ==# 'dark'
    ...
    highlight markdownTSTextReference guifg=#8D9499 guibg=NONE guisp=NONE gui=underline cterm=underline
    " dark end
    ...
    highlight markdownTSTextReference guifg=#4F5E68 guibg=NONE guisp=NONE gui=underline cterm=underline
    " light end
