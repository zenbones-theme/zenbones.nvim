...
if &background ==# 'dark'
    ...
    highlight Normal guifg=#B4BDC3 guibg=#1C1917 guisp=NONE
    highlight Bold guifg=NONE guibg=NONE guisp=NONE gui=bold cterm=bold
    highlight! link LightspeedUnlabeledMatch Bold
    highlight! link TSStrong Bold
    highlight BufferVisible guifg=#CAD0D4 guibg=NONE guisp=NONE
    highlight BufferVisibleIndex guifg=#CAD0D4 guibg=NONE guisp=NONE
    highlight BufferVisibleSign guifg=#CAD0D4 guibg=NONE guisp=NONE
    highlight CmpItemAbbr guifg=#979FA4 guibg=NONE guisp=NONE
    highlight CmpItemAbbrDeprecated guifg=#64696D guibg=NONE guisp=NONE
    ...
    highlight CmpItemKind guifg=#868C91 guibg=NONE guisp=NONE
    highlight CmpItemMenu guifg=#797F84 guibg=NONE guisp=NONE
    ...
    highlight Cursor guifg=#1C1917 guibg=#C4CACF guisp=NONE
    highlight! link TermCursor Cursor
    highlight CursorLine guifg=NONE guibg=#25211F guisp=NONE
    highlight! link CursorColumn CursorLine
    highlight! link NeogitDiffContextHighlight CursorLine
    highlight! link TelescopeSelection CursorLine
    highlight CursorLineNr guifg=#B4BDC3 guibg=NONE guisp=NONE gui=bold cterm=bold
    highlight Delimiter guifg=#867A74 guibg=NONE guisp=NONE
    ...
    highlight DiffText guifg=#B4BDC3 guibg=#324757 guisp=NONE
    ...
    highlight FloatBorder guifg=#837771 guibg=NONE guisp=NONE
    highlight FoldColumn guifg=#685F5A guibg=NONE guisp=NONE gui=bold cterm=bold
    highlight Folded guifg=#AFA099 guibg=#393431 guisp=NONE
    highlight Function guifg=#B4BDC3 guibg=NONE guisp=NONE
    ...
    highlight Identifier guifg=#979FA4 guibg=NONE guisp=NONE
    highlight! link TSVariable Identifier
    highlight IncSearch guifg=#1C1917 guibg=#BF8FB5 guisp=NONE gui=bold cterm=bold
    highlight! link CurSearch IncSearch
    highlight IndentBlanklineChar guifg=#383432 guibg=NONE guisp=NONE
    highlight Italic guifg=NONE guibg=NONE guisp=NONE gui=italic cterm=italic
    highlight! link TSEmphasis Italic
    highlight! link markdownTSEmphasis Italic
    highlight LightspeedGreyWash guifg=#6E6763 guibg=NONE guisp=NONE
    ...
    highlight LineNr guifg=#685F5A guibg=NONE guisp=NONE
    ...
    highlight NonText guifg=#5C534F guibg=NONE guisp=NONE
    highlight! link EndOfBuffer NonText
    highlight! link Whitespace NonText
    highlight NormalFloat guifg=NONE guibg=#302B29 guisp=NONE
    ...
    highlight NvimTreeCursorLine guifg=NONE guibg=#272321 guisp=NONE
    highlight! link NvimTreeCursorColumn NvimTreeCursorLine
    highlight NvimTreeNormal guifg=#B4BDC3 guibg=#231F1D guisp=NONE
    ...
    highlight Pmenu guifg=NONE guibg=#302B29 guisp=NONE
    highlight PmenuSbar guifg=NONE guibg=#615853 guisp=NONE
    highlight PmenuSel guifg=NONE guibg=#4A433F guisp=NONE
    highlight PmenuThumb guifg=NONE guibg=#8E817B guisp=NONE
    highlight Search guifg=#B4BDC3 guibg=#65435E guisp=NONE
    ...
    highlight SpecialComment guifg=#6E6763 guibg=NONE guisp=NONE
    ...
    highlight StatusLine guifg=#B4BDC3 guibg=#352F2D guisp=NONE
    highlight! link TabLine StatusLine
    highlight StatusLineNC guifg=#CAD0D4 guibg=#272321 guisp=NONE
    ...
    highlight TelescopeBorder guifg=#837771 guibg=NONE guisp=NONE
    highlight TelescopeMatching guifg=#B279A7 guibg=NONE guisp=NONE gui=bold cterm=bold
    highlight TelescopeSelectionCaret guifg=#DE6E7C guibg=#25211F guisp=NONE
    ...
    highlight Type guifg=#A1938C guibg=NONE guisp=NONE
    ...
    highlight VertSplit guifg=#685F5A guibg=NONE guisp=NONE
    highlight Visual guifg=NONE guibg=#3D4042 guisp=NONE
    highlight WarningMsg guifg=#B77E64 guibg=NONE guisp=NONE
    highlight! link DiagnosticWarn WarningMsg
    highlight! link TSWarning WarningMsg
    highlight! link gitcommitOverflow WarningMsg
    highlight WildMenu guifg=#1C1917 guibg=#B279A7 guisp=NONE
    ...
    highlight lCursor guifg=#1C1917 guibg=#797F84 guisp=NONE
    ...
    highlight Normal guifg=#2C363C guibg=#F0EDEC guisp=NONE
    highlight Bold guifg=NONE guibg=NONE guisp=NONE gui=bold cterm=bold
    highlight! link LightspeedUnlabeledMatch Bold
    highlight! link TSStrong Bold
    highlight BufferVisible guifg=#596A76 guibg=NONE guisp=NONE
    highlight BufferVisibleIndex guifg=#596A76 guibg=NONE guisp=NONE
    highlight BufferVisibleSign guifg=#596A76 guibg=NONE guisp=NONE
    highlight CmpItemAbbr guifg=#44525B guibg=NONE guisp=NONE
    highlight CmpItemAbbrDeprecated guifg=#728794 guibg=NONE guisp=NONE
    ...
    highlight CmpItemKind guifg=#556570 guibg=NONE guisp=NONE
    highlight CmpItemMenu guifg=#5E6F7B guibg=NONE guisp=NONE
    ...
    highlight! link helpHyperTextJump Constant
    highlight! link helpOption Constant
    highlight Cursor guifg=#F0EDEC guibg=#2C363C guisp=NONE
    highlight! link TermCursor Cursor
    highlight CursorLine guifg=NONE guibg=#E9E4E2 guisp=NONE
    highlight! link CursorColumn CursorLine
    highlight! link NeogitDiffContextHighlight CursorLine
    highlight! link TelescopeSelection CursorLine
    highlight CursorLineNr guifg=#2C363C guibg=NONE guisp=NONE gui=bold cterm=bold
    highlight Delimiter guifg=#8E817B guibg=NONE guisp=NONE
    highlight! link markdownLinkTextDelimiter Delimiter
    highlight! link NeogitNotificationError DiagnosticError
    ...
    highlight! link NeogitDiffDeleteHighlight DiffDelete
    highlight DiffText guifg=#2C363C guibg=#A9BED1 guisp=NONE
    highlight Directory guifg=NONE guibg=NONE guisp=NONE gui=bold cterm=bold
    highlight Error guifg=#A8334C guibg=NONE guisp=NONE
    highlight! link DiagnosticError Error
    highlight! link ErrorMsg Error
    highlight! link TSDanger Error
    highlight FloatBorder guifg=#786D68 guibg=NONE guisp=NONE
    highlight FoldColumn guifg=#A4968F guibg=NONE guisp=NONE gui=bold cterm=bold
    highlight Folded guifg=#564E4A guibg=#CDC2BC guisp=NONE
    highlight Function guifg=#2C363C guibg=NONE guisp=NONE
    highlight! link TroubleNormal Function
    highlight! link TroubleText Function
    ...
    highlight Identifier guifg=#44525B guibg=NONE guisp=NONE
    highlight! link TSVariable Identifier
    highlight IncSearch guifg=#F0EDEC guibg=#C074B2 guisp=NONE gui=bold cterm=bold
    highlight! link CurSearch IncSearch
    highlight IndentBlanklineChar guifg=#D4CDCA guibg=NONE guisp=NONE
    highlight Italic guifg=NONE guibg=NONE guisp=NONE gui=italic cterm=italic
    highlight! link TSEmphasis Italic
    highlight! link markdownTSEmphasis Italic
    highlight LightspeedGreyWash guifg=#948985 guibg=NONE guisp=NONE
    highlight! link HopUnmatched LightspeedGreyWash
    ...
    highlight LineNr guifg=#A4968F guibg=NONE guisp=NONE
    highlight! link CocCodeLens LineNr
    highlight! link LspCodeLens LineNr
    highlight! link NeogitHunkHeader LineNr
    highlight! link SignColumn LineNr
    ...
    highlight! link NnnNormalNC NnnNormal
    highlight NnnVertSplit guifg=bg guibg=NONE guisp=NONE
    highlight NonText guifg=#BBABA3 guibg=NONE guisp=NONE
    highlight! link EndOfBuffer NonText
    highlight! link Whitespace NonText
    highlight NormalFloat guifg=NONE guibg=#DDD6D3 guisp=NONE
    highlight Number guifg=#2C363C guibg=NONE guisp=NONE gui=italic cterm=italic
    highlight! link Boolean Number
    highlight! link TSConstBuiltin Number
    highlight! link TSConstMacro Number
    highlight! link TSVariableBuiltin Number
    highlight NvimTreeCursorLine guifg=NONE guibg=#E1DCD9 guisp=NONE
    highlight! link NvimTreeCursorColumn NvimTreeCursorLine
    highlight NvimTreeNormal guifg=#2C363C guibg=#E9E4E2 guisp=NONE
    highlight! link NnnNormal NvimTreeNormal
    ...
    highlight NvimTreeVertSplit guifg=bg guibg=NONE guisp=NONE
    highlight Pmenu guifg=NONE guibg=#DAD3CF guisp=NONE
    highlight PmenuSbar guifg=NONE guibg=#B2A39B guisp=NONE
    highlight PmenuSel guifg=NONE guibg=#C4B6AF guisp=NONE
    highlight PmenuThumb guifg=NONE guibg=#F7F6F5 guisp=NONE
    highlight Search guifg=#2C363C guibg=#DEB9D6 guisp=NONE
    highlight! link CocSearch Search
    highlight! link MatchParen Search
    highlight! link Sneak Search
    highlight! link LightspeedPendingOpArea SneakLabel
    ...
    highlight! link helpHyperTextEntry Special
    highlight! link markdownTSPunctSpecial Special
    highlight SpecialComment guifg=#948985 guibg=NONE guisp=NONE
    highlight! link markdownTSURI SpecialComment
    ...
    highlight! link WhichKey Statement
    highlight! link markdownTSTitle Statement
    highlight StatusLine guifg=#2C363C guibg=#D6CDC9 guisp=NONE
    highlight! link TabLine StatusLine
    highlight StatusLineNC guifg=#596A76 guibg=#E1DCD9 guisp=NONE
    highlight! link TabLineFill StatusLineNC
    highlight TSConstant guifg=#44525B guibg=NONE guisp=NONE gui=bold cterm=bold
    highlight TabLineSel guifg=NONE guibg=NONE guisp=NONE gui=bold cterm=bold
    highlight! link BufferCurrent TabLineSel
    highlight TelescopeBorder guifg=#786D68 guibg=NONE guisp=NONE
    highlight TelescopeMatching guifg=#88507D guibg=NONE guisp=NONE gui=bold cterm=bold
    highlight TelescopeSelectionCaret guifg=#A8334C guibg=#E9E4E2 guisp=NONE
    highlight Title guifg=#2C363C guibg=NONE guisp=NONE gui=bold cterm=bold
    highlight Todo guifg=NONE guibg=NONE guisp=NONE gui=bold,underline cterm=bold,underline
    highlight Type guifg=#6A5549 guibg=NONE guisp=NONE
    highlight! link helpSpecial Type
    highlight! link markdownTSLiteral Type
    highlight Underlined guifg=NONE guibg=NONE guisp=NONE gui=underline cterm=underline
    highlight! link TSUnderline Underlined
    highlight VertSplit guifg=#A4968F guibg=NONE guisp=NONE
    highlight Visual guifg=NONE guibg=#CBD9E3 guisp=NONE
    highlight WarningMsg guifg=#944927 guibg=NONE guisp=NONE
    highlight! link DiagnosticWarn WarningMsg
    highlight! link TSWarning WarningMsg
    highlight! link gitcommitOverflow WarningMsg
    highlight WildMenu guifg=#F0EDEC guibg=#88507D guisp=NONE
    highlight! link SneakLabel WildMenu
    ...
    highlight! link NvimTreeGitDeleted diffRemoved
    highlight lCursor guifg=#F0EDEC guibg=#4D5C65 guisp=NONE
    highlight! link TermCursorNC lCursor
    highlight! link markdownCode markdownTSLiteral
