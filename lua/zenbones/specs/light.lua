...
local function generate(p, opt)
	...
	local base = lush(function()
		return {
			...
			LineNr          { fg = Normal.bg.da(32), bg = opt.solid_line_nr and Normal.bg.da(4) or "NONE" }, -- Line number for ":number" and ":#" commands, and when 'number' or 'relativenumber' option is set.
